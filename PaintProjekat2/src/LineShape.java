...
public class LineShape extends Shape {
    ...
    public LineShape(int x1, int y1, int x2, int y2, Color borderColor, Color fillColor) {
    ...
    public Rectangle getBounds() {
        ...
        return new Rectangle(minX - 6, minY - 6, 
                            Math.abs(x2 - x1) + 12, Math.abs(y2 - y1) + 12);
    }
    
    @Override
    public Shape copy() {
        return new LineShape(x1, y1, x2, y2, borderColor, fillColor);
    }
